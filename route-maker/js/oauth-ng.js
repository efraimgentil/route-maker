...
accessTokenService.factory('AccessToken', ['Storage', '$rootScope', '$location', '$interval', '$cookies'
  , function(Storage, $rootScope, $location, $interval, $cookies){
  ...
  var setTokenInCookie = function(){
    $cookies.remove('token');
    $cookies.putObject("token" ,service.token);
  }
